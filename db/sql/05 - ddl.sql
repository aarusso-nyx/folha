...
-- ----------------------------------------------------------------------------
-- ----------------------------------------------------------------------------
DROP ENUM IF EXISTS folha.carreira_nivel CASCADE;
CREATE ENUM folha.carreira_nivel ('A','B','C','D','E');

DROP ENUM IF EXISTS folha.carreira_grau CASCADE;
CREATE ENUM folha.carreira_grau ('1', '2', '3', '4', '5');
...
INSERT INTO folha.vinculos_tipos (vinculo) 
VALUES ('Efetivo'), ('Comissionado'), ('Contratado'), ('Estagiário'), ('Terceirizado');
...
) INHERITS (audit.auditable, folha.periodo);
...
INSERT INTO folha.rubrica_tipos (rubrica_tipo)
VALUES ('Provento'), ('Desconto'), ('Indenização'), ('Dedução'), ('Base de Cálculo'), ('Base de Incidência'), 
       ('Base de Contribuição'), ('Base de Desconto'), ('Base de Indenização'), ('Base de Dedução'), ('Base de Provento');
